    ...
    public void createIndicators(String[] states) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (Channel$.MODULE$.SLEEPING().equals(state)) {
                indicator.setBackgroundResource(R.drawable.indicator_item_sleeping);
            } else if (Channel$.MODULE$.CLOSING().equals(state)) {
                indicator.setBackgroundResource(R.drawable.indicator_item_closing);
            } else if (Channel$.MODULE$.SUSPENDED().equals(state)) {
                indicator.setBackgroundResource(R.drawable.indicator_item_suspended);
            } else {
                indicator.setBackgroundResource(R.drawable.indicator_item_default);
            }
        }
    }
